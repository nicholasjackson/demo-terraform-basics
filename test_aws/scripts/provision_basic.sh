...
ExecStart=/usr/bin/docker run -p 80:8080 -e RAG_EMBEDDING_MODEL_AUTO_UPDATE=true -v /etc/open_web_ui.d:/root/.open_web_ui -v /etc/open-webui.d:/app/backend/data --name %n ghcr.io/open-webui/open-webui:ollama
